...
SEND_CHOICES=[(1,'Email when Moderator Publish'),
         (2,'Email on Every Publish')]
...
class UserProfileForm(forms.ModelForm):
    ...
    class Meta:
        model = UserProfile
        fields = ("location", "timezone", 'email_send')
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['email_send'] = forms.ChoiceField(choices=SEND_CHOICES, widget=forms.RadioSelect(), label='Email send')
